...
echo "[$(date +%m/%d-%H:%M)] PASS2 CHAIN DONE: $(ls $L/v2regen/done_* | wc -l) cells done, variants $(ls vlm-with-cpl/new_data/outputs/*/v_ensemble_{noise05,noise10,noise20,noise30,n100,n300,boltz}_seed[012].pt 2>/dev/null | wc -l)/189" >> $L/v2regen/progress.log
