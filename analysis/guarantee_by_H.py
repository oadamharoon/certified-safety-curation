...
import sys as _s
ARM = os.environ.get("HARM", "H30")
CFGF = {"H10": "config_h10.yaml", "H30": "config.yaml", "H50": "config_h50.yaml"}[ARM]
SUF  = {"H10": "_h10", "H30": "", "H50": "_h50"}[ARM]
...
SIZES = [200]
TASKS = "halfcheetah_velocity walker2d_velocity ant_velocity hopper_velocity swimmer_velocity cargoal1_dsrl cargoal2 pointgoal1_dsrl pointgoal2".split()
...
for task in TASKS:
    ...
    out[task] = entry
dst = f"/home/omniverse/workspace/safevlmcpl/iclr2027/data/review_response/guarantee_{ARM}_2000.json"
