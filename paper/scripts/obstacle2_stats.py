...
sys.path.insert(0, REPO)   # VEnsemble / segment_utils live with the training code
...
def main():
    ...
    dst = os.path.join(os.path.dirname(HERE), "data", "obstacle2_stats.json")   # HERE is iclr2027/scripts
